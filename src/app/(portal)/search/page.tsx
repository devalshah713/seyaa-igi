...
import { canonicalOptions, fancyColorOptions } from "@/lib/facets";

export default async function SearchPage() {
  const [shape, colorFancy, clarity, cut, polish, symmetry, fluorescence, growthType, location, agg, total] = await Promise.all([
    canonicalOptions("shape"), fancyColorOptions(), canonicalOptions("clarity"),
  ...
  const facets = {
    shape, colorFancy, clarity, cut, polish, symmetry, fluorescence, growthType, location,
